...
export class AgentService {
  ...
  constructor(
    ...
    private readonly executionCoordinator: AgentExecutionCoordinator = {
  ...
  async deleteAgent(id: string): Promise<{ archivedWorkspace: string }> {
    ...
    await this.executionCoordinator.cancelForAgent(id);
  ...
  async sendMessage(
    ...
    await this.executionCoordinator.assertAgentAvailableForDirect(agentId);
    const timestamp = now();
  ...
  private async cancelExecution(agentId: string): Promise<void> {
    ...
    try {
      ...
      if (execution) {
        await this.runner.cancel(execution.executionId);
      }
      if (execution) {
